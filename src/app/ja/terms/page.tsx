  ...
  return (
    <div className="mx-auto flex w-full max-w-3xl flex-col gap-6 px-4 py-10">
      ...
      <section className="space-y-3 text-sm leading-relaxed text-muted-foreground">
        ...
        <p>
          調査クエリや生成された調査プロンプトは、計画生成、証拠要約、最終レポート作成のために Google Gemini に送信されます。画像検索を有効にした場合は、関連する検索語が Google Programmable Search Engine や Wikimedia Commons に送信されることがあります。これらの外部サービスでは、それぞれの利用規約とプライバシーポリシーに基づいて処理が行われます。
        </p>
        <p>
      ...
      <section id="usage-notes" className="space-y-4 rounded-lg border border-border bg-card p-4">
        ...
        <p className="text-sm text-muted-foreground">
          本サービスは、氏名・会社名・役職などの入力情報をもとに、検索エンジンを活用して Web上の公開情報を横断的に収集・整理するためのツールです。
        </p>
        <div className="space-y-2">
          ...
          <ul className="list-disc space-y-1 pl-5 text-sm text-muted-foreground">
            ...
            <li>送信したクエリは Google Gemini、および設定時には Google や Wikimedia の画像関連 API に中継される場合があります。</li>
